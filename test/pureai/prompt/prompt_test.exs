defmodule PureAI.PromptTest do
  ...
  #   @invalid_attrs %{content: nil, is_default: nil, title: nil}
  ...
  #     valid_attrs = %{content: "some content", is_default: true, title: "some title"}
  ...
  #     assert prompt_template.title == "some title"
  #   end
  ...
  #     assert prompt_template.title == "some updated title"
  #   end
